...
<?php endif; ?>
	...
	<li class="et-social-icon et-social-youtube">
		<a href="<?php echo esc_url( et_get_option( 'divi_youtube_url', 'https://www.youtube.com/channel/UCH3ylKukbQZCk8pN3XALyhQ' ) ); ?>" class="icon">
			<span><?php esc_html_e( 'Youtube', 'Divi' ); ?></span>
		</a>
	</li>
	
	<li class="et-social-icon et-social-discord">
		<a href="https://discord.gg/UvKNewj" class="icon">
			<span><?php esc_html_e( 'Discord', 'Divi' ); ?></span>
		</a>
	</li>
</ul>